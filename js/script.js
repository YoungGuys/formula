...
var i = 0.04; //гарантированая ставка инвестиционного дохода определенная на момент заключения догова страхования
var gender = "man"; // пол man || girl
var OMEGA = 100;  //максимальный возраст в таблице смертности (100)
var x = 30;  // возраст на момент заключения договора
var k = 20;  // количество лет оплаты страховфых взносов
var m = 2;  // количество оплат в год
var n = 20;  // срок действия договора страхования
var delta = Math.log(1 + i);  // хз чьо




// количество доживших до возраста index
...
/*
    Определение нетто тарифов по рискам основной программы
    смерть риск смерти Застрахованого
 */
...
// количество умерших в возрасте index
var d = function(index) {
